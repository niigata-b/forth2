...
<body>
	...
	<form action="SubmitUpdateEmployeeServlet" method="post">
		...
		<p>
			...
			<input type="text" id="name" name="name" maxlength="12" value="<%= emp.getName() %>" pattern=".*\S+.*" required placeholder="入力してください">
		</p>
		<p>
		...
		<p>
			<label for="section_name">部署名:</label>
		...
		<p>
			<input type="hidden" name="update_datetime" value="<%= emp.getUpdate_datetime() %>">
		</p>
	</form>
